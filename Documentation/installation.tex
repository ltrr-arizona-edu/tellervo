...
\begin{enumerate}
 ...
 \item Rename the server if you choose, then press the finish button
 ...
 \item The server will boot and eventually present you with a command line login screen.  Log in with the details:
    ...
    \end{description}
 \item Start the server configuration by typing: \code{sudo corina-server}
 \item Answer the questions and the configuration will finish by testing your new server (see figure \ref{fig:serverconfig}). Note the URL of your new Corina webservice as you will need to enter this when you start your Corina desktop client.  If you need to know the URL at a later date you can run the tests again by typing: \code{corina-server --test}
\end{enumerate}
