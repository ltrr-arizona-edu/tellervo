...
\index{PLJava}
Beyond the standard database functions discussed in section \ref{txt:cpgdbfunctions}, the Tellervo database uses PLJava perform for more complex tasks.  PLJava means that we can leverage the full power of Java to perform calculations and analyses on the database.  
