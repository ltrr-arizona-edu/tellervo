...
Tellervo Server 2.1 is packaged for current Debian- and Ubuntu-based systems.
...
The package selects a supported PostgreSQL dependency bundle. Tellervo Server 2.1
...
\begin{description}
 ...
 \code{sudo apt install ./tellervo\_2.1.4\_amd64.deb}
