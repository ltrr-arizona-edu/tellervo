...
\newdimen\listinglineheight
\newcommand{\listingnumbergutter}{%
  \begingroup
  \listinglineheight=\baselineskip
  \setlength{\fboxsep}{0pt}%
  \smash{\colorbox{listingnumberbg}{%
    \makebox[2em][r]{%
      \vrule width 0.4pt height .72\listinglineheight
        depth .28\listinglineheight}}}%
  \endgroup}
