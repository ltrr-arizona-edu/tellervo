    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof WSIMessage) {
            final WSIMessage copy = ((WSIMessage) draftCopy);
            ...
            if (this.isSetCode()) {
                ...
                Integer copyCode = ((Integer) strategy.copy(LocatorUtils.property(locator, "code", sourceCode), sourceCode));
