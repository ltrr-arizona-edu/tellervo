    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            CorinaRequestType lhsType;
            lhsType = this.getType();
            CorinaRequestType rhsType;
        ...
        {
            CorinaRequestFormat lhsFormat;
            lhsFormat = this.getFormat();
            CorinaRequestFormat rhsFormat;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof WSIRequest) {
            ...
            if (this.isSetType()) {
                ...
                CorinaRequestType copyType = ((CorinaRequestType) strategy.copy(LocatorUtils.property(locator, "type", sourceType), sourceType));
            ...
            if (this.isSetFormat()) {
                ...
                CorinaRequestFormat copyFormat = ((CorinaRequestFormat) strategy.copy(LocatorUtils.property(locator, "format", sourceFormat), sourceFormat));
