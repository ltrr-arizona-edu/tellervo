 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://dendro.cornell.edu/schema/corina/1.0}securityUser" minOccurs="0"/>
    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            CorinaRequestType lhsRequestType;
            lhsRequestType = this.getRequestType();
            CorinaRequestType rhsRequestType;
        ...
        {
            CorinaRequestStatus lhsStatus;
            lhsStatus = this.getStatus();
            CorinaRequestStatus rhsStatus;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof WSIHeader) {
            ...
            if (this.isSetRequestType()) {
                ...
                CorinaRequestType copyRequestType = ((CorinaRequestType) strategy.copy(LocatorUtils.property(locator, "requestType", sourceRequestType), sourceRequestType));
            ...
            if (this.isSetStatus()) {
                ...
                CorinaRequestStatus copyStatus = ((CorinaRequestStatus) strategy.copy(LocatorUtils.property(locator, "status", sourceStatus), sourceStatus));
