...
/**
 * Use PreferencesDialog instead
 * @author pwb48
 * @deprecated
 */
public class OldPreferencesDialog extends Ui_PreferencesPanel {

	private static final long serialVersionUID = -4079890077696526465L;
	// it's really important to only show one prefs dialog! :)
	private static JFrame dialog;
	private static OldPreferencesDialog pfdialog;
	...
	public synchronized static void showPreferencesAtTabIndex(int i) {
		...
		pfdialog = new OldPreferencesDialog();
