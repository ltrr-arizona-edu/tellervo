...
public class ImportEntityListComboBox extends ComboBoxFilterable {
	...
	public final static Object NEW_ITEM = new IrrelevantEntity("From import file...");
	public final static Object SEPARATOR_ITEM = new IrrelevantEntity("------");
	
	public ImportEntityListComboBox(List<? extends ITridas> entities) {
	...
	public ImportEntityListComboBox() {
		super(new FilterableComboBoxModel());
