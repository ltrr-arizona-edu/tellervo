...
public class DOISampleLabelStyle extends AbstractTellervoLabelStyle {
	    ...
	    private final static Logger log = LoggerFactory.getLogger(DOISampleLabelStyle.class);

	
	public DOISampleLabelStyle() {
		super("Department of Interior Sample Label", "Label for use on 3 x 1.75\" Tyvek tags", ItemType.SAMPLE);
	}
