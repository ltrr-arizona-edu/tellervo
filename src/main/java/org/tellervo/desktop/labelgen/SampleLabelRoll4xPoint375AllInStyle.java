...
public class SampleLabelRoll4xPoint375AllInStyle extends AbstractTellervoLabelStyle {
	    ...
	    private final static Logger log = LoggerFactory.getLogger(SampleLabelRoll4xPoint375AllInStyle.class);
