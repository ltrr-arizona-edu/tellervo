...
public class BoxLabelStyleB20By4 extends AbstractTellervoLabelStyle {
	...
	public BoxLabelStyleB20By4() {
	  
		super("Box label Style B - 20x4", "Box label style B with full summary of contents for a box with a 20x4\\\" face", 
				ItemType.BOX,
	...
	private float getLabelRightWithPadding()
	{
		return getLabelRight()-this.padding;
	...
	private float getLabelCenterCutY()
	{
		return pageSize.getHeight()/2;
	}
	...
	private void writeBoxLabel(WSIBox b) throws Exception
	{
        ...
        cb.rectangle(rect1);
        rect1 = new Rectangle(getLabelLeft(), 
				getLabelCenterCutY()-labBarHeight,
				getLabelRight(),
				getLabelCenterCutY());
        rect1.setBackgroundColor(BaseColor.DARK_GRAY);
        rect1.setBorder(Rectangle.BOX);
		...
		if(getLine5OverrideText()!=null)
		{
			...
			float xpos = getLabelLeft()+inchToPoint(3.5f)+padding;
		...
		// Chroma label box	
		Rectangle rect2 = new Rectangle(getLabelLeft(), getLabelCenterCutY(), getLabelLeft()+inchToPoint(3.5f), countryLLY);
        ...
        // Side block box
        rect2 = new Rectangle(getLabelLeft(), inchToPoint(1f), getLabelLeft()+inchToPoint(3.5f), countryLLY);
        //rect2.setBackgroundColor(BaseColor.LIGHT_GRAY);
        rect2.setBorder(Rectangle.BOX);
        rect2.setBorderColor(BaseColor.BLACK);
        rect2.setBorderWidth(0.5f);
		...
		// Logo block box
		Rectangle rect3 = new Rectangle(getLabelLeft()+inchToPoint(3.5f), 
				getLabelCenterCutY(), 
				getLabelLeft()+inchToPoint(3.5f)+inchToPoint(logowidth)+padding+padding,
				countryLLY);
		...
		if(showLabelBoundingBox)
		{
	        ...
	        rect = new Rectangle(0, getLabelCenterCutY(), pageSize.getWidth(), pageSize.getHeight()	);
	        rect.setBorder(Rectangle.BOX);
	        rect.setBorderWidth(1);
	        rect.setBorderColor(BaseColor.BLACK);
	        cb.rectangle(rect);
		...
		float barheight = 43;
    	ct = new ColumnText(cb);   
		int llx = (int) getLabelLeft();
    	int lly = (int) getLabelCenterCutY();
    	int urx = (int) getLabelLeft()+inchToPoint(3.5f);
    	int ury = (int) (getLabelCenterCutY()+barheight);
    	int leading = 1;
		...
		{
			rect2 = new Rectangle(getLabelRight()-inchToPoint(2.5f)+3, getLabelCenterCutY()+3, getLabelRight()-3, countryLLY-3);
	        //rect2.setBackgroundColor(BaseColor.LIGHT_GRAY);
	        rect2.setBorder(Rectangle.BOX);
	        rect2.setBorderColor(BaseColor.BLACK);
	        ...
	        ct = new ColumnText(cb);
			ct.setSimpleColumn(getLabelRight()-inchToPoint(2.5f)+3, getLabelCenterCutY()+3, getLabelRight()-3,  countryLLY-8,
					10f, 
		...
		ct.setSimpleColumn(
				getLabelLeftWithPadding(),
				getLabelBottom(),
				getLabelRightWithPadding(), 
				this.getLabelCenterCutY()-labBarHeight,
				1f,
				Element.ALIGN_LEFT);
