...
public class AdminDatabaseStatisticsAction extends AbstractAction {

	private static final long serialVersionUID = 1L;
	
	public AdminDatabaseStatisticsAction() {
        super("Database statistics", Builder.getIcon("statistics.png", 22));
		putValue(SHORT_DESCRIPTION, "Database statistics");
