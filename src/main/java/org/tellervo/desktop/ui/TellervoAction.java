...
public abstract class TellervoAction extends AbstractAction {
	 ...
	 * @param key
	 */
	public TellervoAction(String key) {
	 ...
	 * @param icon
	 */
	public TellervoAction(String key, Icon icon) {
	 ...
	 * @param iconName
	 */
	public TellervoAction(String key, String iconName, int iconSize) {
	 ...
	 */
	public TellervoAction(String key, String iconName, String iconPackageName, int iconSize) {
	...
	private class ButtonSelectionActionAdapter implements PropertyChangeListener, ItemListener {
		...
		public void propertyChange(PropertyChangeEvent evt) {
			...
			if(lastValue != selected) {
				lastValue = selected;
				TellervoAction.this.selectionStateChanged(selected);
			}
		}
