...
class sample 
{
    ...
    function setSpecimenType($sampleType)
    {
        // Set speciemn type id from name
        $mySpecimenType = new sampleType;
        $mySpecimenType->setParamsFromName($sampleType);
        $this->sampleType=$mySpecimenType->getName();
    }

    function setSpecimenTypeID($sampleTypeID)
    {
    ...
    function setSpecimenQuality($sampleQuality)
    {
        // Set sample quality from name
        $this->sampleQuality=$sampleQuality;
    }

    function setSpecimenQualityID($sampleQualityID)
    {
    ...
    function setSpecimenContinuity($sampleContinuity)
    {
        // Set sample continuity from name
        $this->sampleContinuity=$sampleContinuity;
    }

    function setSpecimenContinuityID($sampleContinuityID)
    {
    ...
    function setParamsFromDB($theID)
    {
        ...
        if ($dbconnstatus ===PGSQL_CONNECTION_OK)
        {
            ...
            else
            {
                ...
                $this->isSpecimenQualityVerified= fromPGtoPHPBool($row['issamplequalityverified']);
                $this->sampleContinuity = $row['samplecontinuity'];
                $this->isSpecimenContinuityVerified = fromPGtoPHPBool($row['issamplecontinuityverified']);
                $this->pith = $row['pith'];
            ...
            if ($dbconnstatus ===PGSQL_CONNECTION_OK)
            {
                ...
                if($this->id == NULL)
                {
                    ...
                    $sql = "insert into tblsample ( ";
                        ...
                        if(isset($this->isSpecimenQualityVerified)) $sql.="issamplequalityverified, ";
                ...
                else
                {
                    ...
                    $sql.="update tblsample set ";
                        ...
                        if(isset($this->isSpecimenQualityVerified)) $sql.="issamplequalityverified='" .fromPHPtoPGBool($this->isSpecimenQualityVerified)     ."', ";
