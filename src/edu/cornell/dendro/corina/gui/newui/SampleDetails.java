/*
 * Created by JFormDesigner on Thu Feb 21 14:56:55 GMT 2008
 */
...
public class SampleDetails extends JPanel {
	...
	private void initComponents() {
		...
		add(siteDetailsPanel, cc.xy(1, 1));
		...
		add(locationMapPanel, cc.xywh(3, 1, 1, 3));
		...
		add(treeDetailsPanel, cc.xy(1, 3));
		...
		add(specimenDetailsPanel, cc.xywh(1, 5, 3, 1));
		...
		add(measurementDetailsPanel, cc.xywh(1, 7, 2, 1));
	...
	public static void showMe(){
		...
		SampleDetails myDialog = new SampleDetails();
		myDialog.show();
