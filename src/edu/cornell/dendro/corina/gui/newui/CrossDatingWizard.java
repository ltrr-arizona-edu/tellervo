 ...
 * @author  peterbrewer
 */
public class CrossDatingWizard extends javax.swing.JDialog {
    
    /** Creates new form CrossDatingWizard */
    public CrossDatingWizard(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CrossDatingWizard dialog = new CrossDatingWizard(new javax.swing.JFrame(), true);
