...
/**
 ...
 @version $Id$
 */
public class ExportDialogLegacy extends JDialog {
	 ...
	 */
	public ExportDialogLegacy(Sample s, Frame parent) {
	...
	/**
	 ...
	 @param parent window
	 */
	public ExportDialogLegacy(List samples, Frame parent, boolean savePacked) {
		super(parent, I18n.getText("export"), true);
