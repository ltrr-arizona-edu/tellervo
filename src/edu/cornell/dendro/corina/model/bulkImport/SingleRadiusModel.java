 ...
 *
 */
public class SingleRadiusModel extends HashModel {
	...
	public static final String IMPORTED = "Radius Imported";
	
	public static final String[] PROPERTIES = {
		SAMPLE_CODE, RADIUS_CODE, TITLE, COMMENTS, AZIMUTH, IMPORTED
	};
