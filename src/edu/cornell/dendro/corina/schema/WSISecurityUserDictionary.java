...
public class WSISecurityUserDictionary implements Serializable, CopyTo, Copyable, Equals, HashCode, ToString
{
    ...
    public void toString(ToStringBuilder toStringBuilder) {
        {
            List<WSISecurityUserDictionary.User> theUsers;
    ...
    public Object copyTo(Object target, CopyBuilder copyBuilder) {
        ...
        {
            List<WSISecurityUserDictionary.User> sourceUsers;
            sourceUsers = this.getUsers();
            List<WSISecurityUserDictionary.User> copyUsers = ((List<WSISecurityUserDictionary.User> ) copyBuilder.copy(sourceUsers));
            copy.unsetUsers();
            List<WSISecurityUserDictionary.User> uniqueUsersl = copy.getUsers();
        ...
        implements Serializable, CopyTo, Copyable, Equals, HashCode, ToString
    {
        ...
        public void equals(Object object, EqualsBuilder equalsBuilder) {
            if (!(object instanceof WSISecurityUserDictionary.User)) {
                equalsBuilder.appendSuper(false);
                return ;
            }
            if (this == object) {
            ...
            final WSISecurityUserDictionary.User that = ((WSISecurityUserDictionary.User) object);
        ...
        public void toString(ToStringBuilder toStringBuilder) {
            {
                WSISecurityUserDictionary.User.MemberOf theMemberOf;
        ...
        public Object copyTo(Object target, CopyBuilder copyBuilder) {
            final WSISecurityUserDictionary.User copy = ((target == null)?((WSISecurityUserDictionary.User) createCopy()):((WSISecurityUserDictionary.User) target));
            {
                WSISecurityUserDictionary.User.MemberOf sourceMemberOf;
                sourceMemberOf = this.getMemberOf();
                WSISecurityUserDictionary.User.MemberOf copyMemberOf = ((WSISecurityUserDictionary.User.MemberOf) copyBuilder.copy(sourceMemberOf));
        ...
        public Object createCopy() {
            return new WSISecurityUserDictionary.User();
        }
            ...
            implements Serializable, CopyTo, Copyable, Equals, HashCode, ToString
        {
            ...
            public void equals(Object object, EqualsBuilder equalsBuilder) {
                if (!(object instanceof WSISecurityUserDictionary.User.MemberOf)) {
                    equalsBuilder.appendSuper(false);
                    return ;
                }
                if (this == object) {
                ...
                final WSISecurityUserDictionary.User.MemberOf that = ((WSISecurityUserDictionary.User.MemberOf) object);
            ...
            public Object copyTo(Object target, CopyBuilder copyBuilder) {
                final WSISecurityUserDictionary.User.MemberOf copy = ((target == null)?((WSISecurityUserDictionary.User.MemberOf) createCopy()):((WSISecurityUserDictionary.User.MemberOf) target));
                {
            ...
            public Object createCopy() {
                return new WSISecurityUserDictionary.User.MemberOf();
            }
