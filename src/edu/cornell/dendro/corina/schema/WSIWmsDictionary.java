...
@XmlRootElement(name = "wmsDictionary")
public class WSIWmsDictionary implements Serializable, CopyTo, Copyable, Equals, HashCode, ToString
{
    ...
    public void equals(Object object, EqualsBuilder equalsBuilder) {
        if (!(object instanceof WSIWmsDictionary)) {
        ...
        final WSIWmsDictionary that = ((WSIWmsDictionary) object);
    ...
    public Object copyTo(Object target, CopyBuilder copyBuilder) {
        final WSIWmsDictionary copy = ((target == null)?((WSIWmsDictionary) createCopy()):((WSIWmsDictionary) target));
