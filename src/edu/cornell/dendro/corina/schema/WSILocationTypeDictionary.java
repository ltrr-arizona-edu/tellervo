...
public class WSILocationTypeDictionary implements Serializable
{

    protected List<ControlledVoc> locationType;
     ...
     * 
     */
    public List<ControlledVoc> getLocationType() {
        if (locationType == null) {
            locationType = new ArrayList<ControlledVoc>();
        }
