 ...
 *         &lt;element name="requestType" type="{http://dendro.cornell.edu/schema/corina/1.0}corinaRequestFormat"/>
...
public class WSIHeader {
    ...
    @XmlElement(required = true)
    protected CorinaRequestFormat requestType;
    @XmlElement(required = true)
     ...
     *     
     */
    public CorinaRequestFormat getRequestType() {
        return requestType;
    }
     ...
     *     
     */
    public void setRequestType(CorinaRequestFormat value) {
