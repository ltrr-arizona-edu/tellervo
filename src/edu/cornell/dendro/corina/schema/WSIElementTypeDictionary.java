...
public class WSIElementTypeDictionary implements Serializable
{

    protected List<ControlledVoc> elementType;
     ...
     * 
     */
    public List<ControlledVoc> getElementType() {
        if (elementType == null) {
            elementType = new ArrayList<ControlledVoc>();
        }
