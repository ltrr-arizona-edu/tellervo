...
public class WMSLayersPanel extends JPanel
{
    ...
    public WMSLayersPanel(WorldWindow wwd, String serverURI, String serverName, Dimension size) throws URISyntaxException
    {
        super(new BorderLayout());

        // See if the server name is a valid URI. Throw an exception if not.
        this.serverURI = new URI(serverURI.trim()); // throws an exception if server name is not a valid uri.
