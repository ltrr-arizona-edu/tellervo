 ...
 * <h2>Left to do:</h2>
 * <ul>
 * <li>Use different methods for accessing browser data? (browser.table,
 * browser.getSelectedFilenames(), browser.getSelectedElements())
	...
	private void initMenuItems() {
		...
		addSeparator();
		{
			...
			A.addActionListener(new AbstractAction() {
				public void actionPerformed(ActionEvent e) {
					ElementList files = browser.getSelectedElements();

					ElementList fixed = ElementList.singletonList(files.get(0));
					ElementList moving = ElementList.singletonList(files.get(1));
			...
			B.addActionListener(new AbstractAction() {
				public void actionPerformed(ActionEvent e) {
					...
					new CrossdateKit(new Sequence(new ElementList(), files));
			...
			C.addActionListener(new AbstractAction() {
				public void actionPerformed(ActionEvent e) {
					...
					new CrossdateKit(new Sequence(files, new ElementList()));
					// REFACTOR: should crossdatekit take lists, too?
				}
			});
