    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof WSIStatistic)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final WSIStatistic that = ((WSIStatistic) object);
        {
            String lhsKey;
            lhsKey = this.getKey();
            String rhsKey;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof WSIStatistic) {
            final WSIStatistic copy = ((WSIStatistic) draftCopy);
            if (this.isSetKey()) {
                String sourceKey;
