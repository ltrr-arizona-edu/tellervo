 ...
 *       &lt;attribute name="memberOf" type="{http://www.tellervo.org/schema/1.0}idList" />
...
public class WSISecurityUser implements Cloneable, CopyTo, Equals, HashCode, ToString, HumanName, IdAble
{
