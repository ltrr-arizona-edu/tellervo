    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    protected WSIRequest.Statistics statistics;
    ...
    @XmlElement(name = "curation")
    protected List<WSICuration> curations;
     ...
     * @return
     *     possible object is
     *     {@link WSIRequest.Statistics }
     *     
     */
    public WSIRequest.Statistics getStatistics() {
        return statistics;
    }
     ...
     *     
     */
    public void setStatistics(WSIRequest.Statistics value) {
    ...
    /**
     * Gets the value of the curations property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the curations property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCurations().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<WSICuration> getCurations() {
        if (curations == null) {
            curations = new ArrayList<WSICuration>();
        }
        return this.curations;
    }

    public boolean isSetCurations() {
        return ((this.curations!= null)&&(!this.curations.isEmpty()));
    }

    public void unsetCurations() {
        this.curations = null;
    }
    ...
    public List<WSILoan> getLoen() {
        if (loen == null) {
            loen = new ArrayList<WSILoan>();
        }
        return this.loen;
    }

    public boolean isSetLoen() {
        return ((this.loen!= null)&&(!this.loen.isEmpty()));
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            WSIRequest.Statistics theStatistics;
        ...
        {
            List<WSICuration> theCurations;
            theCurations = (this.isSetCurations()?this.getCurations():null);
            strategy.appendField(locator, this, "curations", buffer, theCurations);
        }
        {
            List<WSILoan> theLoen;
            theLoen = (this.isSetLoen()?this.getLoen():null);
            strategy.appendField(locator, this, "loen", buffer, theLoen);
        }
        {
            List<WSITag> theTags;
            theTags = (this.isSetTags()?this.getTags():null);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            WSIRequest.Statistics lhsStatistics;
            lhsStatistics = this.getStatistics();
            WSIRequest.Statistics rhsStatistics;
        ...
        {
            List<WSICuration> lhsCurations;
            lhsCurations = (this.isSetCurations()?this.getCurations():null);
            List<WSICuration> rhsCurations;
            rhsCurations = (that.isSetCurations()?that.getCurations():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "curations", lhsCurations), LocatorUtils.property(thatLocator, "curations", rhsCurations), lhsCurations, rhsCurations)) {
                return false;
            }
        }
        {
            List<WSILoan> lhsLoen;
            lhsLoen = (this.isSetLoen()?this.getLoen():null);
            List<WSILoan> rhsLoen;
            rhsLoen = (that.isSetLoen()?that.getLoen():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "loen", lhsLoen), LocatorUtils.property(thatLocator, "loen", rhsLoen), lhsLoen, rhsLoen)) {
                return false;
            }
        }
        {
            List<WSITag> lhsTags;
            lhsTags = (this.isSetTags()?this.getTags():null);
            List<WSITag> rhsTags;
            rhsTags = (that.isSetTags()?that.getTags():null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            List<WSICuration> theCurations;
            theCurations = (this.isSetCurations()?this.getCurations():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "curations", theCurations), currentHashCode, theCurations);
        }
        {
            List<WSILoan> theLoen;
            theLoen = (this.isSetLoen()?this.getLoen():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "loen", theLoen), currentHashCode, theLoen);
        }
        {
            List<WSITag> theTags;
            theTags = (this.isSetTags()?this.getTags():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof WSIRequest) {
            ...
            if (this.isSetStatistics()) {
                WSIRequest.Statistics sourceStatistics;
                sourceStatistics = this.getStatistics();
                WSIRequest.Statistics copyStatistics = ((WSIRequest.Statistics) strategy.copy(LocatorUtils.property(locator, "statistics", sourceStatistics), sourceStatistics));
            ...
            if (this.isSetCurations()) {
                List<WSICuration> sourceCurations;
                sourceCurations = (this.isSetCurations()?this.getCurations():null);
                @SuppressWarnings("unchecked")
                List<WSICuration> copyCurations = ((List<WSICuration> ) strategy.copy(LocatorUtils.property(locator, "curations", sourceCurations), sourceCurations));
                copy.unsetCurations();
                List<WSICuration> uniqueCurationsl = copy.getCurations();
                uniqueCurationsl.addAll(copyCurations);
            } else {
                copy.unsetCurations();
            }
            if (this.isSetLoen()) {
                List<WSILoan> sourceLoen;
                sourceLoen = (this.isSetLoen()?this.getLoen():null);
                @SuppressWarnings("unchecked")
                List<WSILoan> copyLoen = ((List<WSILoan> ) strategy.copy(LocatorUtils.property(locator, "loen", sourceLoen), sourceLoen));
                copy.unsetLoen();
                List<WSILoan> uniqueLoenl = copy.getLoen();
                uniqueLoenl.addAll(copyLoen);
            } else {
                copy.unsetLoen();
            }
            if (this.isSetTags()) {
                List<WSITag> sourceTags;
                sourceTags = (this.isSetTags()?this.getTags():null);
                @SuppressWarnings("unchecked")
                List<WSITag> copyTags = ((List<WSITag> ) strategy.copy(LocatorUtils.property(locator, "tags", sourceTags), sourceTags));
                copy.unsetTags();
                List<WSITag> uniqueTagsl = copy.getTags();
    ...
    /**
     * Sets the value of the curations property.
     * 
     * @param curations
     *     allowed object is
     *     {@link WSICuration }
     *     
     */
    public void setCurations(List<WSICuration> curations) {
        this.curations = curations;
    }

    /**
     * Sets the value of the loen property.
     * 
     * @param loen
     *     allowed object is
     *     {@link WSILoan }
     *     
     */
    public void setLoen(List<WSILoan> loen) {
        this.loen = loen;
    }
     ...
     *     
     */
    public void setTags(List<WSITag> tags) {
        this.tags = tags;
    }
        ...
        implements Cloneable, CopyTo, Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof WSIRequest.Statistics)) {
                return false;
            }
            if (this == object) {
                return true;
