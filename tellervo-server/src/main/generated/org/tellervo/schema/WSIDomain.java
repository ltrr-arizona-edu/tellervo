    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof WSIDomain)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final WSIDomain that = ((WSIDomain) object);
        {
            String lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof WSIDomain) {
            final WSIDomain copy = ((WSIDomain) draftCopy);
            if (this.isSetValue()) {
                String sourceValue;
            ...
            if (this.isSetPrefix()) {
                String sourcePrefix;
                sourcePrefix = this.getPrefix();
                String copyPrefix = ((String) strategy.copy(LocatorUtils.property(locator, "prefix", sourcePrefix), sourcePrefix));
                copy.setPrefix(copyPrefix);
            } else {
                copy.prefix = null;
            }
        }
