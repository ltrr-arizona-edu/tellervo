    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    /**
     * Information, warning or error messages associated with the request Gets the value of the messages property.
     * 
     * <p>
    ...
    /**
     * A cryptographic nonce provided by the server to enable the client to perform a secure login
     * 
     * @return
     *     possible object is
     *     {@link WSINonce }
    ...
    /**
     * Information, warning or error messages associated with the request
     * 
     * @param messages
     *     allowed object is
     *     {@link WSIMessage }
