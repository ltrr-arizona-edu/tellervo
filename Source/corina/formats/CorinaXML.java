...
/**
   ...
   @version $Id: Corina.java 738 2006-07-12 03:27:55Z lucasmo $
 */
public class CorinaXML implements Filetype {
	...
	public void saveContainer(CXMLContainer c, BufferedWriter w) throws IOException {
	}

	public void saveHeader(List<CXMLContainer> l, BufferedWriter w) throws IOException {		
		w.write("<contents>");
		w.newLine();
		...
		for(int i = 0; i < l.size(); i++) {
			...
			w.write("  <object type=\"dendro\" guid=\"" + c.GUID + "\">");
			w.write(c.name);
			w.write("</object>");
			w.newLine();
		}
