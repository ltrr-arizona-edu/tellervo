...
\newcommand{\warn}[1]{\begin{center}{\fcolorbox{dgrey}{lgrey}{\parbox{15cm}{\includegraphics[width=3mm]{Images/warning.png} \emph{#1}}}}\end{center}}
...
\newcommand{\code}[1]{\begin{center}{\colorbox{lgrey}{\parbox{15cm}{\includegraphics[width=3mm]{Images/code.png}\texttt{#1}}}}\end{center}}

%% Define commands for typesetting menu entries
\newcommand{\menutwo}[2]{\emph{#1 {\MVRightarrow} #2}}
\newcommand{\menuthree}[3]{\emph{#1 {\MVRightarrow} #2 {\MVRightarrow} #3}}
\newcommand{\menufour}[4]{\emph{#1 {\MVRightarrow} #2 {\MVRightarrow} #3 {\MVRightarrow} #4}}
