...
To index your data, first you need to open the series you would like to index.  Next choose Tools \MVRightarrow Index to display the indexing dialog (figure \ref{fig:index}).
