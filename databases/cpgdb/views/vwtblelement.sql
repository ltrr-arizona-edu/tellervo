...
CREATE VIEW vwtblelement AS
 SELECT tblelement.comments, tblelement.elementid, tblelement.taxonid, tblelement.locationprecision, tblelement.code as title,  tblelement.code, tblelement.createdtimestamp, tblelement.lastmodifiedtimestamp, 
