...
insert into tlkptaxon (colid, colparentid, taxonrankid, label, htmllabel, taxonid, parenttaxonid) values ('4HQ4Z', '6Q7C', 9, 'Picea sitchensis (Bong.) Carrière', '<i>Picea sitchensis</i> (Bong.) Carrière', '4HQ4Z', '6Q7C') ON CONFLICT DO NOTHING;
